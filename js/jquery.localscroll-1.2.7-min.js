/**
 * jQuery.LocalScroll - Animated scrolling navigation, using anchors. Copyright (c) 2007-2009 Ariel Flesler -
 * aflesler(at)gmail(dot)com | http://flesler.blogspot.com Dual licensed under MIT and GPL. Date: 3/11/2009
 * 
...
(function($) {
   ...
   $.fn.localScroll = function(b) {
      ...
      function d() {
         return !!this.href && !!this.hash && this.href.replace(this.hash, '') == l
